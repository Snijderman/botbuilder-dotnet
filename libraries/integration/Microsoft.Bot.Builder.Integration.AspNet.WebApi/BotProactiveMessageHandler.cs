...
namespace Microsoft.Bot.Builder.Integration.AspNet.WebApi.Handlers
{
    public sealed class BotProactiveMessageHandler : BotMessageHandlerBase
    {
        ...
        public BotProactiveMessageHandler(BotFrameworkAdapter botFrameworkAdapter, IActivitySerializer activitySerializer) : base(botFrameworkAdapter, activitySerializer)
        {
        }
