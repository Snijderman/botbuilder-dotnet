...
namespace Microsoft.Bot.Builder
{
    ...
    public class MemoryTranscriptStore : ITranscriptStore
    {
        ...
        public Task<PagedResult<Activity>> GetTranscriptActivitiesAsync(string channelId, string conversationId, string continuationToken = null, DateTime startDate = default(DateTime))
        {
            if (channelId == null)
            {
